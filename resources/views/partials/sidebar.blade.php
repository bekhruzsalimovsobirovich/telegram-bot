    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-section">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.peoples') }}" class="nav-link {{ request()->routeIs('admin.peoples') ? 'active' : '' }}">
                        <i class="ph-users"></i>
                        <span>Foydalanuvchilar</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin.appeals') }}" class="nav-link {{ request()->routeIs('admin.appeals') ? 'active' : '' }}">
                        <i class="ph-users"></i>
